...
This will generate a data directory in the current directory, `witness_node_data_dir`, which contains the blockchain directory for the data store and a :ref:`config.ini <bts-config-ini-eg>` configuration file.
...
* See more information about :ref:`Memory Reduction for Nodes >memory-nodes>`.
...
Reference: `:ref:`User Guide - Permissions <acc-permission>`_
