...
|||
|---|---|
|  [--plugins arg   ](/source/full-witness_nodes/nodes_memory_reduction.md#--plugins) |  Space-separated list of plugins to activate |

### Options for plugin accout_history

|||
|---|---|
|  [--track-account arg ](/source/full-witness_nodes/nodes_memory_reduction.md#--track-account) | Account ID to track history for (may specify multiple times) |
| [--max-ops-per-account arg](/source/full-witness_nodes/nodes_memory_reduction.md#--max-ops-per-account) | Maximum number of operations per account will be kept in memory |
| [--partial-operations arg](/source/full-witness_nodes/nodes_memory_reduction.md#--partial-operations)  | Keep only those operations in memory that are related to account history tracking |
