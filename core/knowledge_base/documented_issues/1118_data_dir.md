...
#### Research:
I checked a witness_node executable main() for a part of another issue and created a [code flow](https://github.com/bitshares/dev.bitshares.works/blob/master/core/knowledge_base/shared_files/witness_node_ex-codeflows.pdf) (in page 8) to view the flow.
