...
2. [Creating a Testnet folder](#2-creating-a-testnet-folder)
3. [Creating a Genesis File for a Private Testnet](#3-creating-a-genesis-file-for-a-private-testnet)
4. [Customization of the Genesis File](#4-customization-of-the-genesis-file)
5. [Embedding Genesis (optional)](#5-embedding-genesis-optional)
6. [Creating a Data Directory](#6-creating-a-data-directory)
7. [Setting up Witness Configuration](#7-setting-up-witness-configuration)
8. [Starting Block Production](#8-starting-block-production)
9. [Obtaining the Chain ID](#9-obtaining-the-chain-id)
10. [Creating a new Wallet](#10-creating-a-new-wallet)
11. [Gaining Access to the Genesis Stake](#11-gaining-access-to-the-genesis-stake)
12. [Creating Another Account](#12-creating-another-account)
13. [Creating Committee Members](#13-creating-committee-members)
