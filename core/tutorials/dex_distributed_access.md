...
### Contents:
- [BitShares Node Setup](../tutorials/dex_distributed_access.md#bitshares-node-setup)
- [Create a New User](../tutorials/dex_distributed_access.md#install-nginx)
- [Install NGINX](../tutorials/dex_distributed_access.md#configure-nginx)
   - Configure Nginx
...
- [Install letsencrypt](../tutorials/dex_distributed_access.md#install-letsencrypt)
...
- [Add SSL to Nginx settings](../tutorials/dex_distributed_access.md#add-ssl-to-nginx-settings)
   - Edit altcap.io
   - Restart Nginx
- [Install BitShares Web GUI](../tutorials/dex_distributed_access.md#install-bitshares-web-gui)
   - Install NVM (Node Version Manager)
   - Setup light wallet
   - Link web root to gui build folder
   - Build light wallet
- [SSL Test ](../tutorials/dex_distributed_access.md#ssl-test)
